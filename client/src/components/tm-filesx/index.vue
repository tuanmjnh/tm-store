<template>
  <div class="tm-files">
    <tm-file-list :files="files" :loading="loadingFile" :view-type.sync="viewType" :selected.sync="selected"
      :multiple="multiple">
      ...
      <template v-slot:panel-left>
        <div class="panel-left">
          ...
          <tm-tree v-show="!loadingDir" :nodes="directories" :selected.sync="treeSelected" nodeKey="id" nodeLabel="name"
