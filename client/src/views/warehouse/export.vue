<template>
  <q-card flat bordered>
    <q-toolbar>
      ...
      <q-btn v-if="!result&&items&&items.length" type="submit" no-caps :dense="$store.getters.dense.button" color="blue"
        :label="$t('product.export')" :loading="loading" class="q-btn--square q-mr-sm" @click.prevent="onSubmit" />
      <!--icon="offline_pin" -->
        ...
        <template v-slot:top="props">
          <div class="col-12 row">
            <div v-if="result" class="col-xs-12 col-sm-auto self-center">
              <span>{{$t('product.export_success')}}</span><b class="text-positive">{{result.data.code}}</b>
            </div>
            <q-space />
            <div class="col-xs-12 col-sm-auto self-center text-right">
              <div class="col-auto self-center">
                ...
                <printer-form v-if="result" :title="$t('product.export_ballot')" :label="$t('product.print')"
                  :labelDate="$t('product.export_date')" :items="items" :result="result" />
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            ...
            <q-td key="price" :props="props">
              ...
              <q-input v-else v-model="props.row.price" debounce="300" :label="$t('product.price_export')" type="number"
            ...
            <q-td key="quantity" :props="props">
              ...
              <q-input v-else v-model="props.row.quantity" debounce="300" :label="$t('product.quantity_export')"
