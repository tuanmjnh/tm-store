...
// const eventListener = (ele) => {
//   const ul = ele.nextSibling as any
//   ul.classList.toggle('hidden')
// }
// const onCollapseToggle = () => {
//   const attribute = 'data-collapse-toggle'
//   const eles = document.querySelectorAll(`[${attribute}]`)
//   for (let i = 0; i < eles.length; i++) {
//     eles[i].addEventListener('click', () => { eventListener(eles[i]) }, true);
//   }
// }
</script>

<template>
  <!-- <van-popup v-model:show="showLeft" :style="{ padding: '64px' }">Content</van-popup> -->
  <!-- <van-popup v-model:show="isLeftMenu" position="left" :style="{ width: '80%', height: '100%' }">
    <van-cell-group class="cell-left">
