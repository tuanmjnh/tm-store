 ...
 * @returns {Boolean}
 */
export const validUsername = function (str) {
 ...
 * @returns {Boolean}
 */
export const validURL = function (url) {
 ...
 * @returns {Boolean}
 */
export const validLowerCase = function (str) {
  const reg = /^[a-z]+$/
  return reg.test(str)
}
 ...
 * @returns {Boolean}
 */
export const validUpperCase = function (str) {
  const reg = /^[A-Z]+$/
  return reg.test(str)
}
 ...
 * @returns {Boolean}
 */
export const validAlphabets = function (str) {
  const reg = /^[A-Za-z]+$/
  return reg.test(str)
}
